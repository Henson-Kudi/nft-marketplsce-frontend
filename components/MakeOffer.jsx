...
export default forwardRef(function MakeOffer(
    {
        text,
        tokenAddress,
        tokenId,
        ...
        await runContractFunction({
            ...
            onSuccess: async (tx) => {
                ...
                const reqParams = {
                    ...
                    function_name: text === "Place Bid" ? "bid" : "offer",
                    function_desc: text,
                ...
                const res = await handlePostRequest("/offers", reqParams, {})
                ...
                await getTokenData()
                dispatchSuccess(
                    text === "Place Bid" ? "Bid placed successfully" : "Offer placed successfully"
                )
            },
